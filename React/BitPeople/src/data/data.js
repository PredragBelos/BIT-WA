...
export const birdthdayIcon = <i className="fa fa-birthday-cake iconMargin" aria-hidden="true"></i>;
export const emailIcon = <i className="fa fa-envelope iconMargin" aria-hidden="true"></i>;
